...
const Ks2Template = ({ contractor, client, sections, contractNumber, contractDate }: Ks2TemplateProps) => (
  <Document>
    {sections.map((section, index) => {
      ...
      return (
        <Page key={`${section.projectName}-${index}`} size="A4" style={styles.page}>
          <Text style={styles.title}>Акт о приемке выполненных работ (КС-2)</Text>
