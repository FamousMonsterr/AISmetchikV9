...
const TypingAnimation = ({ words }: { words: string[] }) => {
    ...
    return (
        <motion.span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
            {displayText}
        </motion.span>
    );
};
        ...
        <section className="relative pt-24 pb-20 text-center">
            <div className="container mx-auto">
                 <motion.h1
                    ...
                    className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground flex flex-col items-center justify-center"
                >
                ...
                >
                    Превращаем часы ручной работы в минуты. AI-помощник для профессиональных сметчиков и монтажников.
                </motion.p>
                 <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
