...
import { onSnapshot, collection, query, orderBy, limit, DocumentData, DbClientError } from '@/lib/db-client';
...
export default function AdminLogsPage() {
  ...
  const getActionInfo = (log: DocumentData) => {
    ...
    switch (log.action) {
        ...
        case 'PRO_PAYMENT_SUBMITTED': return { icon: BadgeDollarSign, text: `Оплата PRO отправлена` };
