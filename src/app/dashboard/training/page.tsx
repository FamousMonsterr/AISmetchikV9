...
import { onSnapshot, collection, query, orderBy } from '@/lib/db-client';
      ...
      <Card>
        <CardHeader className="flex flex-row items-start justify-between">
            <div>
              ...
              <CardDescription>
                Изучите материалы, чтобы максимально эффективно использовать все возможности Montage HUB и повысить свой партнерский статус.
              </CardDescription>
            </div>
             {isEditor && (
