    ...
    const handleSendToBot = async (format: FileFormat) => {
        ...
        startGenerating(async () => {
            try {
                ...
                const result = await sendFileToTelegramUser({ fileData: base64Data, fileName: fileData.fileName, chatId: user.telegramChatId });
            ...
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-xl">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={() => handleSendToBot('pdf')} disabled={isGenerating || !user?.telegramChatId}>
