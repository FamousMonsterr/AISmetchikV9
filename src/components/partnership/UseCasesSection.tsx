...
const cases = [
    ...
    },
    {
        ...
        description: "Вы уже работаете с клиентами в сфере строительства или безопасности? Предлагайте 'AI Сметчик' как дополнительную ценность при продаже основного оборудования.",
    },
    {
        id: "agent",
        icon: Users,
