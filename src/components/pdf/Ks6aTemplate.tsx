...
const Ks6aTemplate = ({ contractor, client, sections, contractNumber, contractDate }: Ks6aTemplateProps) => (
  <Document>
    {sections.map((section, index) => {
      ...
      return (
        <Page key={`${section.projectName}-${index}`} size="A4" style={styles.page}>
          <Text style={styles.title}>Журнал учета выполненных работ (КС-6а)</Text>
