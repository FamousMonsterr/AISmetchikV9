...
const steps = [
    ...
    { 
        ...
        icon: Database,
        details: "Предлагайте 'Montage HUB' как часть комплексной автоматизации для ваших клиентов. Вы не только получаете процент от их платежей, но и можете оказывать платные услуги по настройке интеграции с их CRM (AmoCRM, Битрикс24, 1С)."
    },
    { 
