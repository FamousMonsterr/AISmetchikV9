  ...
  const onSubmit = (values: z.infer<typeof FormSchema>) => {
    ...
    startTransition(async () => {
        ...
        if (isEditMode) {
            ...
            const newCompanyData = { ...values, userId: user.uid, isDefault: false, isClient: isClientValue };
            result = await addCompany(newCompanyData);
        }
        ...
        <DialogHeader>
          <DialogTitle>
            {isEditMode
              ...
              : isClientValue ? 'Добавить контрагента' : 'Добавить мою компанию'}
          </DialogTitle>
          <DialogDescription>
            ...
            <ScrollArea className="h-[70vh] p-1 pr-4">
                <div className="space-y-4">
                    <div className="text-xs text-muted-foreground">
                      Группа: {isClientValue ? 'Контрагенты' : 'Мои компании'}
                    </div>
