  ...
  return (
    <Card className="max-w-4xl mx-auto">
      ...
      <CardContent className="prose prose-sm max-w-none">
        ...
        <ul>
          <li>Регистрация и аутентификация в сервисе «Montage HUB».</li>
        ...
        <p>
          Настоящее согласие действует с момента его предоставления и в течение всего периода использования сервиса «Montage HUB», а также в течение 3 (трех) лет после прекращения использования сервиса, либо до момента отзыва настоящего согласия.
        </p>
